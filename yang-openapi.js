...
(function() {
  ...
  var Yang, debug, definitions, discoverOperations, discoverPathParameter, discoverPaths, discoverTags, serializeJSchema, traverse, yaml, yang2jschema, yang2jsobj, yang2jstype;
  ...
  yang2jsobj = function(schema) {
    var choices, js, origin, property, ref, ref1, ref2, ref3, refs, required;
    if (schema == null) {
      return {};
    }
  ...
  yang2jschema = function(schema, item = false) {
    if (schema == null) {
      return {};
    }
    switch (schema.kind) {
  ...
  discoverOperations = function(schema, item = false) {
    var deprecated, origin, ref1, ref10, ref11, ref12, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9;
    if (typeof debug === "function") {
  ...
  discoverPaths = function(schema) {
    var i, len, name, param, paths, ref1, ref2, sub, subpaths;
...
// test if any subpaths have same param.name
        for (i = 0, len = subpaths.length; i < len; i++) {
          sub = subpaths[i];
          if ((ref2 = sub.parameter) != null ? ref2.some(function(x) {
    ...
    return paths.concat(...subpaths);
  };

  discoverTags = function(schema) {
    var name, ref1, ref2, ref3, ref4, tag;
    if ((ref1 = schema.kind) !== 'list' && ref1 !== 'container' && ref1 !== 'rpc' && ref1 !== 'action') {
      return [];
    }
    if (schema['if-feature'] != null) {
    ...
    tag = {
      name: name,
      description: (ref2 = (ref3 = schema.description) != null ? ref3.tag : void 0) != null ? ref2 : `Operations related to ${name}`
    };
    if ((ref4 = schema.reference) != null ? ref4.tag : void 0) {
      tag.externalDocs = {
  ...
  module.exports = require('./yang-openapi.yang').bind({
    transform: function() {
      ...
      modules = this.input.modules.map((name) => {
        return this.schema.constructor.import(name);
      }).filter(function(x) {
        return x != null;
      });
      if (!modules.length) {
      ...
      return this.output = {
        spec: {
          ...
          tag: modules.map(function(m) {
            var ref1, tag;
            tag = {
              name: m.tag,
              description: `Operations related to ${m.tag}`
            };
            if ((ref1 = m.reference) != null ? ref1.tag : void 0) {
              tag.externalDocs = {
